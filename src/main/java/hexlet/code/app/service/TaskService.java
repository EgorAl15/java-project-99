...
public class TaskService {
  ...
  public List<TaskResponseDto> getAll(
      String titleCont, Long assigneeId, String status, Long labelId) {
    ...
    return taskRepository.findAll(specification).stream().map(this::toDto).toList();
  }
  ...
  private TaskResponseDto toDto(Task task) {
    ...
    var labelIds = task.getLabels().stream().map(Label::getId).collect(Collectors.toSet());
